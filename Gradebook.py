...
def GradeSystem(NumStudents):
    ...
    for StudentsEntered in range(NumStudents):
        ...
        print("Welcome. Ensure to input everything honestly as it will be cross-checked by your previous performances.")
        ...
        while True:
            ...
            ConfirmScore = int(input("Confirm your test score"))

            if ConfirmScore != StudentScore:
                print(
                    "The initial and final scores that you have inputted don't match. Try again.")
                continue
...
if __name__ == "__main__":
    ...
    print("Please pass the device to the first student such that they can input their grade.")
